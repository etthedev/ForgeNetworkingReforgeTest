...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"itemData\"]]")]
	public abstract partial class PlayerBehavior : NetworkBehavior
	{
		public const byte RPC_ADD_ITEM_TO_INVENTORY = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("AddItemToInventory", AddItemToInventory, typeof(byte[]));
		...
		/// byte[] itemData
		/// </summary>
		public abstract void AddItemToInventory(RpcArgs args);
