			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case InstanceManagerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new InstanceManagerNetworkObject(networker, id, frame);
						break;
					case LootingGameNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new LootingGameNetworkObject(networker, id, frame);
						break;
					...
					case TestNetworkObject.IDENTITY:
						...
						break;
					case TeleporterNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new TeleporterNetworkObject(networker, id, frame);
						break;
				}
